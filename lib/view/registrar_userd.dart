...
class RegistrarUserd extends StatefulWidget {
  RegistrarUserd({ Key? key }) : super(key: key);

  @override
  _RegistrarUserdState createState() => _RegistrarUserdState();
}

class _RegistrarUserdState extends State<RegistrarUserd>{
  ...
  var urlUsuario = Uri.parse(
      'http://${Constants.IP_CONEXION}/proyecto_topicos/registrar_usuario3.php');
